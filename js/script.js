...
var users = {
	...
	paragon: {
		...
		bot: true,
		avatar: 'https://images-ext-1.discordapp.net/external/quS7ROqrb8PnHHak5Au61WzZuqJHJVQj9wV1rKk_9fA/%3Fwidth%3D454%26height%3D454/https/media.discordapp.net/attachments/836682995237781544/922800878161907752/hagh-bot-logo1.png'
	}
};
...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			...
			pill: 'hsl(202, 35%, 68%)',
			color:`#00FF00`,
			thumb: `https://images-ext-1.discordapp.net/external/quS7ROqrb8PnHHak5Au61WzZuqJHJVQj9wV1rKk_9fA/%3Fwidth%3D454%26height%3D454/https/media.discordapp.net/attachments/836682995237781544/922800878161907752/hagh-bot-logo1.png`,
			fields: [{
				name: 'حق بات',
			}, {
				name: 'سلام ◈ hesam TooVinS',
				value: 'من حق بات هستم یک بات فان و سرگرم کننده برای شما  برای اینکه با دستور های من آشنا بشی میتونی از منو زیر استفاده کنی و لذت ببری مرسی از اینکه من رو انتخاب کردی'
			}, {
				name: 'VOTE : https://top.gg/bot/831937821953884191',
			}, 
			{
				name: '-> برای اطلاع از بیشتر دستور ها',
				value: 'بات را دعوت کنید '
			}]
		},
